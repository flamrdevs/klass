...
import type { GroupOptions, GroupResult, StrictGroupVariantsSchema } from "./../group";
...
type SlotsFn<B extends string, T extends StrictGroupVariantsSchema<B>> = ((props?: { [K in keyof T]?: TransformKey<keyof T[K]> }) => KlassedOnly<B, T>) & {
