...
import type { BaseComponent, Classes, SignalishRecord, SupportedElementType } from "./preact";
...
export type KlassedComponent<ET extends SupportedElementType, VS extends FinalVariantsSchema> = (<C extends SupportedElementType = ET>(
	props: PolymorphicComponentProps<C, WithClassesValueProps<SignalishRecord<VariantsOf<KlassFn<VS>>>>>
) => JSX.Element) &
	Base<KlassFn<VS>>;
...
export type ReklassedComponent<ET extends SupportedElementType, CS extends ConditionSchema, VS extends FinalVariantsSchema> = (<C extends SupportedElementType = ET>(
	props: PolymorphicComponentProps<C, WithClassesValueProps<SignalishRecord<VariantsOf<ReklassFn<CS, VS>>>>>
) => JSX.Element) &
...
export type ComposedComponent<ET extends SupportedElementType, Fn extends Fx> = (<C extends SupportedElementType = ET>(
	props: PolymorphicComponentProps<C, WithClassesValueProps<SignalishRecord<VariantsOf<ComposeFn<Fn>>>>>
) => JSX.Element) &
	Base<ComposeFn<Fn>>;
