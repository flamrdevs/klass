...
import { A, Button, DefinedA, DefinedButton, DefinedDiv, DefinedSetupFnA, DefinedSetupFnButton, DefinedSetupFnDiv, Div, RequiredA, RequiredButton, RequiredDiv } from "./~res/components";
	...
	describe("klassed", () => {
		...
		describe("defined", () => {
			...
			describe("polymorphic", () => {
				it("A", () => {
					const Component = poly.klassed("span", KLASS_OPTIONS);
					utils.expectElementRoot(<Component {...PROPS} as={DefinedA} id="id" />).tagName("A");
				});

				it("Button", () => {
					const Component = poly.klassed("span", KLASS_OPTIONS);
					utils.expectElementRoot(<Component {...PROPS} as={DefinedButton} id="id" />).tagName("BUTTON");
				});
			});
		});
		...
		describe("defined setup fn", () => {
			...
			describe("polymorphic", () => {
				it("A", () => {
					const Component = poly.klassed("span", KLASS_OPTIONS);
					utils.expectElementRoot(<Component {...PROPS} as={DefinedSetupFnA} id="id" />).tagName("A");
				});

				it("Button", () => {
					const Component = poly.klassed("span", KLASS_OPTIONS);
					utils.expectElementRoot(<Component {...PROPS} as={DefinedSetupFnButton} id="id" />).tagName("BUTTON");
				});
			});
		});
	});
	...
	describe("reklassed", () => {
		...
		describe("defined", () => {
			...
			describe("polymorphic", () => {
				it("Div", () => {
					const Component = poly.reklassed("span", REKLASS_OPTIONS);
					utils.expectElementRoot(<Component {...PROPS} as={DefinedDiv} id="id" />).tagName("DIV");
				});
			});
		});
		...
		describe("defined setup fn", () => {
			...
			describe("polymorphic", () => {
				it("Div", () => {
					const Component = poly.reklassed("span", REKLASS_OPTIONS);
					utils.expectElementRoot(<Component {...PROPS} as={DefinedSetupFnDiv} id="id" />).tagName("DIV");
				});
			});
		});
	});
