...
export type MonoKlassedComponent<ET extends SupportedElementType, VS extends FinalVariantsSchema> = ((
	props: WithClassesValueProps<OverrideProps<SupportedComponentProps<ET>, SignalishRecord<VariantsOf<KlassFn<VS>>>>>
) => JSX.Element) &
	Base<KlassFn<VS>>;
...
export type MonoReklassedComponent<ET extends SupportedElementType, CS extends ConditionSchema, VS extends FinalVariantsSchema> = ((
	props: WithClassesValueProps<OverrideProps<SupportedComponentProps<ET>, SignalishRecord<VariantsOf<ReklassFn<CS, VS>>>>>
) => JSX.Element) &
	Base<ReklassFn<CS, VS>>;

export type MonoComposedComponent<ET extends SupportedElementType, Fn extends Fx> = ((
	props: WithClassesValueProps<OverrideProps<SupportedComponentProps<ET>, SignalishRecord<VariantsOf<ComposeFn<Fn>>>>>
) => JSX.Element) &
	Base<ComposeFn<Fn>>;
