...
<p align="center">
  <a title="license" href="https://github.com/flamrdevs/klass/blob/main/LICENSE">
    <img title="license" alt="license" src="https://klass.deno.dev/pkg/l/solid" hspace="1">
  </a>
  <a title="version" href="https://www.npmjs.com/package/@klass/solid">
    <img title="version" alt="version" src="https://klass.deno.dev/pkg/v/solid" hspace="1">
  </a>
  <a title="size" href="https://bundlejs.com/?q=@klass/solid">
    <img title="size" alt="size" src="https://klass.deno.dev/pkg/mz/solid" hspace="1">
  </a>
  <img title="npm monthly downloads" alt="size" src="https://klass.deno.dev/pkg/dm/solid" hspace="1">
</p>
