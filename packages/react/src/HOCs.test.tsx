...
describe("cxsed", async () => {
  ...
  it("basic", async () => {
    const { getByTestId } = render(
      <>
        <DivCXS data-testid="div" className={["extra", "classes"]}>
          div
        </DivCXS>
      </>
    );
  ...
  it("reactive", async () => {
    const ReactiveComponent = () => {
      ...
      return (
        <>
          <ButtonCXS data-testid="button-a" className={classes} onClick={handleClick}>
            button-a
          </ButtonCXS>

          <ButtonCXS data-testid="button-b" className={classes} onClick={handleClick}>
            button-b
          </ButtonCXS>
        </>
      );
