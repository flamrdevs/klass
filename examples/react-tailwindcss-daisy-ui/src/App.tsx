...
const Header = () => {
  ...
  const title = "React TailwindCSS DaisyUI";
    ...
    <header className="container mx-auto mb-2 max-w-screen-lg">
      <div className="p-8 flex justify-between items-center gap-4">
        ...
        <div>
          <button
            type="button"
            className="px-3 py-1 outline-none bg-base-100 hover:bg-base-200 text-base-content rounded-lg shadow-lg text-base font-medium"
            onClick={toggleTheme}
          >
    ...
    <main className="container mx-auto my-2 p-4 max-w-screen-lg space-y-4">
      <Section title="Box">
        <Section.Group title="Padding">
          <Box p={{ base: "sm", md: "md" }} className="border border-base-300">
            p=(base=sm,md=md)
          </Box>
          <Box px={{ base: "md", md: "lg" }} className="border border-base-300">
            px=(base=md,md=lg)
          </Box>
          <Box py={{ base: "lg", md: "xl" }} className="border border-base-300">
            py=(base=lg,md=xl)
          </Box>
        </Section.Group>

        <Section.Group title="Margin">
          <Box m={{ base: "sm", md: "md" }} className="border border-base-300">
            m=(base=sm,md=md)
          </Box>
          <Box mx={{ base: "md", md: "lg" }} className="border border-base-300">
            mx=(base=md,md=lg)
          </Box>
          <Box my={{ base: "lg", md: "xl" }} className="border border-base-300">
            my=(base=lg,md=xl)
          </Box>
        </Section.Group>
      </Section>
